...
// The migration tests deliberately roll back databases they populated themselves.
// In real use `down` refuses while audit_log has rows, because dropping it destroys
// a trail nothing can reconstruct.
process.env.ALLOW_DESTRUCTIVE_ROLLBACK ??= 'yes'
